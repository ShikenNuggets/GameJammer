...
ButtonID ConvertSDLKeycodeToButtonID(SDL_Keycode key_){
	switch(key_){
		...
		default:
			JLOG_ERROR(String("Unsupported keycode ") + key_);
			break;
	}
...
ButtonID ConvertSDLMouseButtonToButtonID(Uint8 button_){
	switch(button_){
		...
		default:
			JLOG_ERROR(String("Unsupported mouse button index ") + button_);
			break;
	}
...
ButtonID ConvertSDLJoystickButtonToButtonID(Uint8 button_){
	switch(button_){
		...
		default:
			JLOG_ERROR(String("Unsupported gamepad button index ") + button_);
			break;
	}
...
AxisID ConvertSDLJoystickAxisToAxisID(Uint8 axis_){
	switch(axis_){
		...
		default:
			JLOG_ERROR(String("Unsupported gamepad axis index ") + axis_);
			break;
	}
